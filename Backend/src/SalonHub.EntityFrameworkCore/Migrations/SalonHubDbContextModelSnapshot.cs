...
{
    [DbContext(typeof(SalonHubDbContext))]
    partial class SalonHubDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalonHub.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SalonHub.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SalonHub.Domain.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("EmployeeTechnicianId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SalonHub.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SalonHub.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SalonHub.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SalonHub.Authorization.Roles.Role", b =>
                {
                    b.HasOne("SalonHub.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("SalonHub.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("SalonHub.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SalonHub.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("SalonHub.Authorization.Users.User", "ReportingUser")
                        .WithMany()
                        .HasForeignKey("BookingUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SalonHub.Domain.EmployeeTechnicians.EmployeeTechnician", "employeeTechnician")
                        .WithMany()
                        .HasForeignKey("EmployeeTechnicianId");
