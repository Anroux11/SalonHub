    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTechnicians", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeTechnicians_Salons_SalonId",
                        column: x => x.SalonId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingUserId = table.Column<long>(type: "bigint", nullable: false),
                    SalonId = table.Column<Guid>(type: "uuid", nullable: false),
                    EmployeeTechnicianId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_EmployeeTechnicians_EmployeeTechnicianId",
                        column: x => x.EmployeeTechnicianId,
                        principalTable: "EmployeeTechnicians",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_EmployeeTechnicianId",
                table: "Bookings",
                column: "EmployeeTechnicianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTechnicians_SalonId",
